...
To support the new **Sponsored Plans** and **Partner Tokens** features, you must update your database schema.

Please execute the following SQL commands in your database manager (e.g., phpMyAdmin):
