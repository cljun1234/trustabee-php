...
def verify_forgot_password_error():
    with sync_playwright() as p:
        browser = p.chromium.launch(headless=True)
        page = browser.new_page()

        # Verify Forgot Password Page with Error
        forgot_html = """
        <!DOCTYPE html>
        <html lang="en">
        <head>
        ...
        <body>
            <div class="card">
                ...
                <div class="error">Your reset link has expired or is invalid. Please request a new one.</div>
        ...
        print("Forgot Password Error Page Screenshot taken")
